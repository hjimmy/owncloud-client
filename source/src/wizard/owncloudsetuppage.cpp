...
//Added by jian.hou set Default Server Url
void OwncloudSetupPage::setDefaultServerUrl()
{
#ifdef Q_OS_LINUX 
   ...
   if(!f.open(QIODevice::ReadOnly | QIODevice::Text))
   {
	_ui.leUrl->clear();
   	...
   	while(!txtInput.atEnd())
   	{
        ...
        ipaddr = lineStr.section(';', 2, 2);
        ipaddr = ipaddr.section(":",1,1);

        _ui.leUrl->setText("https://"+ipaddr+ ":9091/zcloud");
   }
   f.close();
}
