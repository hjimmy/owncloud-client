...
StrCpy $ConfirmEndProcess_KILLING_PROCESSES_TEXT "杀死科委云盘进程。"
StrCpy $ConfirmEndProcess_KILL_NOT_FOUND_TEXT "未找到要杀死的进程！"
StrCpy $PageReinstall_NEW_Field_1 "您的系统已经安装科委云盘较老版本。建议安装前卸载当前版本。选择将要执行的操作，点击下一步继续。"
...
StrCpy $PageReinstall_NEW_MUI_HEADER_TEXT_SUBTITLE "选择如何安装科委云盘。"
StrCpy $PageReinstall_SAME_Field_2 "添加/重装组件"
StrCpy $PageReinstall_SAME_Field_3 "卸载科委云盘"
StrCpy $UNINSTALLER_APPDATA_TITLE "卸载科委云盘"
StrCpy $SEC_APPLICATION_DETAILS "安装科委云盘基本组件。"
...
StrCpy $OPTION_SECTION_SC_APPLICATION_Desc "科委云盘基本组件。"
StrCpy $OPTION_SECTION_SC_START_MENU_Desc "科委云盘快捷方式。"
StrCpy $OPTION_SECTION_SC_DESKTOP_Desc "科委云盘桌面快捷方式。"
StrCpy $OPTION_SECTION_SC_QUICK_LAUNCH_Desc "科委云盘快速启动栏快捷方式。"
...
StrCpy $ConfirmEndProcess_MESSAGEBOX_TEXT "科委云盘 进程需要关闭，$\n您想让安装程序关闭这些进程吗？"
StrCpy $PageReinstall_OLD_Field_1 "较新版本的 科委云盘 已经安装！安装较旧版本的程序是不推荐的。如果您希望继续安装较旧版本，建议先卸载较新版本。选择您想要执行的操作并>点击下一步以继续。"
StrCpy $PageReinstall_SAME_Field_1 "科委云盘 ${VERSION} 已经安装。\n请选择想要执行的操作并点击下一步。"
StrCpy $PageReinstall_SAME_MUI_HEADER_TEXT_SUBTITLE "选择需要执行的维护选项。"
StrCpy $OPTION_SECTION_SC_START_MENU_DetailPrint "添加 科委云盘 快捷方式到开始菜单。"
StrCpy $UNINSTALLER_APPDATA_SUBTITLE "从电脑中移除 科委云盘 数据文件夹。"
StrCpy $UNINSTALLER_APPDATA_LABEL_1 "移除 科委云盘 数据文件夹？"
StrCpy $UNINSTALLER_APPDATA_LABEL_2 "选择以删除数据文件夹，不选择以保留数据文件夹内容供后续使用。"
StrCpy $UNINSTALLER_REGISTRY_Detail "正在写入注册表"
StrCpy $UNINSTALL_MESSAGEBOX "科委云盘 可能并没有安装在 $INSTDIR。$\n$\n仍然继续吗？(不推荐)"
